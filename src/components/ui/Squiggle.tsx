...
/** The signature Maxis "squiggle" mark, inline so it can inherit sizing. */
export function Squiggle({ className = '', tone = 'green' }: SquiggleProps) {
  return (
    <svg
      viewBox="0 0 51 50"
      className={className}
